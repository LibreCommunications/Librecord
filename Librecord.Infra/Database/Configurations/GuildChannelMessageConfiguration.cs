...
public class GuildChannelMessageConfiguration
    : IEntityTypeConfiguration<GuildChannelMessage>
{
    public void Configure(EntityTypeBuilder<GuildChannelMessage> builder)
    {
        ...
        builder.HasOne(m => m.Message)
            .WithOne(m => m.GuildContext)
            .HasForeignKey<GuildChannelMessage>(m => m.MessageId)
